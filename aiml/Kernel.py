...
from .multi_language.CNSupport import mergeChineseSpace
...
class Kernel:
    ...
    def respond(self, input_, sessionID = _globalSessionID):
        ...
        try:
            ...
            finalResponse = mergeChineseSpace(unicode(finalResponse, "utf-8") if type(finalResponse) == str else finalResponse)
